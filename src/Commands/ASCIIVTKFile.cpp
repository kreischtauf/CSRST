...
void AsciiVtkFile::writeFile(const std::string & baseFileName)
{
    const std::string nl("\n");
...
void AsciiVtkFile::writeHeaderFile(const std::string & baseFileName)
{
    if (Ippl::myNode() == 0) {
...
void AsciiVtkFile::addCoordinates(const Vector_t & dx)
{
...
std::string AsciiVtkFile::concatenateScalarFieldNames() const
{
...
std::string AsciiVtkFile::concatenateVectorFieldNames() const
{
...
std::string AsciiVtkFile::concatenateFields() const
{
    const std::string nl("\n");
    const boost::regex pattern("\n");
    const std::string replaceFormat = nl + std::string(indent_l3);
...
std::string AsciiVtkFile::concatenateFieldHeaders() const
{
    const std::string nl("\n");
    const boost::regex pattern("\n");
    const std::string replaceFormat = nl + std::string(indent_l1);
...
std::string AsciiVtkFile::concatenatePieceExtents(const std::string & pathFile) const
{
    char buffer[50];
